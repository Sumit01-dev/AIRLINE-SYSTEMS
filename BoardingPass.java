...
public class BoardingPass extends JFrame implements ActionListener {
    JTextField tfpnr;
    JLabel tfname,tfnationality,lblsrc, lbldest, labelfname, labelfcode,labeltime;
    JButton fetchButton;
    JLabel labeldate;
    public BoardingPass(){
        ...
        JLabel subheading = new JLabel("Borarding Pass");
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airline/handlers/icons/airindia.png"));
