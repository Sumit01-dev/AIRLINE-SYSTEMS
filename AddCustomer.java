...
public class AddCustomer extends JFrame implements ActionListener {
    ...
    JRadioButton rbothers, rbfemale, rbmale;
    public AddCustomer(){
        ...
        rbothers.setBounds(360, 280, 70, 25);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airline/handlers/icons/emp.png"));
 ...
 public void actionPerformed(ActionEvent ae){
     ...
     try{
         Conn conn = new Conn();
         String query = "insert into passenger values('"+name+"','"+nationality+"','"+phone+"','"+address+"','"+email+"','"+aadhar+"','"+gender+"')";
         conn.s.executeUpdate(query);
         JOptionPane.showMessageDialog(null,"Customer detalils added Successfully");
         setVisible(false);
     }catch(Exception e){
         e.printStackTrace();
     }
